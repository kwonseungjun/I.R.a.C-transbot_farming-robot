...
#include "open_manipulator_master_slave/open_manipulator_master_slave.h"
...
int main(int argc, char **argv)
{
  ...
  OpenManipulatorPMasterSlave open_manipulator_master_slave(usb_port, baud_rate);

  ros::Timer publish_timer = node_handle.createTimer(ros::Duration(open_manipulator_master_slave.getServiceCallPeriod()), &OpenManipulatorPMasterSlave::publishCallback, &open_manipulator_master_slave);
  ros::spin();
