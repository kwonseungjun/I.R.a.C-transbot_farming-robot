...
#ifndef OPEN_MANIPULATOR_P_MASTER_SLAVE_H
#define OPEN_MANIPULATOR_P_MASTER_SLAVE_H
...
class OpenManipulatorPMasterSlave : public RobotisManipulator
{
 private:
  // ROS NodeHandle
 ...
 public:
  OpenManipulatorPMasterSlave(std::string usb_port, std::string baud_rate);
  ~OpenManipulatorPMasterSlave();
...
#endif //OPEN_MANIPULATOR_P_MASTER_SLAVE_H
