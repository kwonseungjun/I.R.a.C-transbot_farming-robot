...
#include "../include/open_manipulator_teleop/open_manipulator_teleop_keyboard.h"
...
class OpenManipulatorTeleop
{
  ...
  *****************************************************************************/
  ...
  /*bool send_kinematic_pose(std::vector<double> A, double B, double C);*/
  /*****************************************************************************
  ** Others
  *****************************************************************************/
