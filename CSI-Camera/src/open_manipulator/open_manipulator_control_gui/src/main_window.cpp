...
void MainWindow::on_btn_init_pose_clicked(void)
{
  ...
  joint_name.push_back("joint2"); joint_angle.push_back(1.572);
  joint_name.push_back("joint3"); joint_angle.push_back(-1.445);
  joint_name.push_back("joint4"); joint_angle.push_back(-0.015);
