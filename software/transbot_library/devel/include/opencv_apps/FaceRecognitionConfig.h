...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(FaceRecognitionConfig::AbstractParamDescriptionConstPtr(new FaceRecognitionConfig::ParamDescription<std::string>("model_method", "str", 0, "Method to recognize faces", "{'enum_description': 'Method to recognize faces', 'enum': [{'srcline': 41, 'description': 'eigen', 'srcfile': '/home/jetson/software/transbot_library/src/opencv_apps/cfg/FaceRecognition.cfg', 'cconsttype': 'const char * const', 'value': 'eigen', 'ctype': 'std::string', 'type': 'str', 'name': 'eigen'}, {'srcline': 42, 'description': 'fisher', 'srcfile': '/home/jetson/software/transbot_library/src/opencv_apps/cfg/FaceRecognition.cfg', 'cconsttype': 'const char * const', 'value': 'fisher', 'ctype': 'std::string', 'type': 'str', 'name': 'fisher'}, {'srcline': 43, 'description': 'LBPH', 'srcfile': '/home/jetson/software/transbot_library/src/opencv_apps/cfg/FaceRecognition.cfg', 'cconsttype': 'const char * const', 'value': 'LBPH', 'ctype': 'std::string', 'type': 'str', 'name': 'LBPH'}]}", &FaceRecognitionConfig::model_method)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 41 "/home/jetson/software/transbot_library/src/opencv_apps/cfg/FaceRecognition.cfg"
      const char * const FaceRecognition_eigen = "eigen";
//#line 42 "/home/jetson/software/transbot_library/src/opencv_apps/cfg/FaceRecognition.cfg"
      const char * const FaceRecognition_fisher = "fisher";
//#line 43 "/home/jetson/software/transbot_library/src/opencv_apps/cfg/FaceRecognition.cfg"
