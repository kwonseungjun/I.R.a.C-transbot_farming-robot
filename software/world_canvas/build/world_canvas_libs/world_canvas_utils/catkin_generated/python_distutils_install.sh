...
echo_and_run cd "/home/jetson/software/world_canvas/src/world_canvas_libs/world_canvas_utils"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/jetson/software/world_canvas/src/world_canvas_libs/world_canvas_utils/setup.py" \
     \
    build --build-base "/home/jetson/software/world_canvas/build/world_canvas_libs/world_canvas_utils" \
    install \
    --root="${DESTDIR-/}" \
