...
echo_and_run cd "/home/jetson/software/world_canvas/src/world_canvas_server"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/jetson/software/world_canvas/src/world_canvas_server/setup.py" \
     \
    build --build-base "/home/jetson/software/world_canvas/build/world_canvas_server" \
    install \
    --root="${DESTDIR-/}" \
