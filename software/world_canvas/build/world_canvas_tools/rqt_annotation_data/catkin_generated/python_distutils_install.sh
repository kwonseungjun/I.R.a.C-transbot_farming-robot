...
echo_and_run cd "/home/jetson/software/world_canvas/src/world_canvas_tools/rqt_annotation_data"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/jetson/software/world_canvas/src/world_canvas_tools/rqt_annotation_data/setup.py" \
     \
    build --build-base "/home/jetson/software/world_canvas/build/world_canvas_tools/rqt_annotation_data" \
    install \
    --root="${DESTDIR-/}" \
