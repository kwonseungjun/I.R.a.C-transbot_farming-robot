...
if("TRUE" STREQUAL "TRUE")
  set(warehouse_ros_mongo_SOURCE_PREFIX /home/jetson/software/world_canvas/src/warehouse_ros_mongo)
  set(warehouse_ros_mongo_DEVEL_PREFIX /home/jetson/software/world_canvas/devel)
  ...
  set(warehouse_ros_mongo_INSTALL_PREFIX /home/jetson/software/world_canvas/install)
...
if(NOT "/home/jetson/software/world_canvas/devel/include;/home/jetson/software/world_canvas/src/warehouse_ros_mongo/include;/usr/include " STREQUAL " ")
  set(warehouse_ros_mongo_INCLUDE_DIRS "")
  set(_include_dirs "/home/jetson/software/world_canvas/devel/include;/home/jetson/software/world_canvas/src/warehouse_ros_mongo/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'warehouse_ros_mongo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jetson/software/world_canvas/src/warehouse_ros_mongo/${idir}'.  ${_report}")
    endif()
    _list_append_unique(warehouse_ros_mongo_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "warehouse_ros_mongo;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libboost_filesystem.so;/usr/lib/aarch64-linux-gnu/libboost_thread.so;/usr/lib/aarch64-linux-gnu/libboost_chrono.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/usr/lib/aarch64-linux-gnu/libboost_atomic.so;/usr/lib/aarch64-linux-gnu/libpthread.so")
