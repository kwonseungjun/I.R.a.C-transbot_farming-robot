  ...
  *****************************************************************************/
  ...
  addJoint("joint3",  // my name
          ...
          math::inertiaMatrix(3.0654178e-05, -1.2764155e-06, -2.6874417e-07,
                              ...
                              2.5155057e-04),
          math::vector3(9.0909590e-02, 3.8929816e-04, 2.2413279e-04)
          );
  addJoint("joint3_5",   // 새 관절
          "joint3",     // parent
          "joint4",     // child
          math::vector3(0.149, 0.0, 0.018),  // 네가 준 값
          math::convertRPYToRotationMatrix(0.0, 0.0, 0.0),
          Z_AXIS,       // 네가 준 축
          16,           // ID 16
          M_PI,         // limit
          ...
          1.0,
          0.1,         // mass (임시값 가능)
          math::inertiaMatrix(1e-5,0,0,1e-5,0,1e-5),
          math::vector3(0,0,0)
          );
          
  addJoint("joint4",  // my name
            "joint3_5",  // parent name
            "gripper", // child name
            math::vector3(0.0, 0.0, 0.041),                 // relative position
            math::convertRPYToRotationMatrix(0.0, 0.0, 0.0), // relative orientation
            Y_AXIS,    // axis of rotation
            14,        // actuator id
